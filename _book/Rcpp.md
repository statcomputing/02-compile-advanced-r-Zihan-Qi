...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x10bedafa0>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)       1.63µs   1.84µs   419838.        0B     0   
#> 2 sumC(x)      3.48µs   7.64µs   127161.    2.49KB     0   
#> 3 sumR(x)     47.66µs  52.14µs    14820.  187.19KB     2.07
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   6.58ms   7.44ms      117.    7.63MB     52.7
#> 2 pdistC(0.5, y)   5.03ms   5.68ms      153.    7.63MB     52.3
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     4.82ms   6.83ms      142.    4.97MB     26.7
#> 2 gibbs_cpp(100, 10) 239.97µs 263.81µs     3507.     4.1KB     21.7
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        1.94ms   2.24ms      412.    7.86KB     20.4
#> 2 vacc2       67.75µs  76.24µs    10009.  153.14KB     29.5
#> 3 vacc3       16.72µs  17.82µs    48225.   14.48KB     14.5
```
