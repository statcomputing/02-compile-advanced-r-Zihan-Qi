...
#> 1 mean1(x)      228µs    272µs     2869.
#> 2 mean2(x)      113µs    117µs     7184.
```
...
#>   expression           min   median `itr/sec`
#>   <bch:expr>      <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)           4.26µs   4.95µs   156178.
#> 2 mean.default(x)   1.91µs   2.14µs   377206.
```
...
#>   expression              min   median `itr/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)              4.21µs   4.89µs   172703.
#> 2 mean.default(x)      1.92µs   2.24µs   371469.
#> 3 .Internal(mean(x))    485ns    527ns  1592802.
```
...
#>   expression              min   median `itr/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)                27µs   29.5µs    30703.
#> 2 mean.default(x)      24.3µs   24.9µs    33233.
#> 3 .Internal(mean(x))   22.6µs   24.6µs    35522.
```
...
#>   expression         min   median `itr/sec`
#>   <bch:expr>    <bch:tm> <bch:tm>     <dbl>
#> 1 as.data.frame   1.36ms    1.7ms      529.
#> 2 quick_df       11.27µs   12.9µs    55018.
```
...
#>   expression        min   median `itr/sec`
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl>
#> 1 lookup[x1]      843ns   1.01µs   804208.
#> 2 lookup[x10]    2.17µs   2.41µs   328668.
#> 3 lookup[x100]   5.01µs   8.52µs    96329.
```
...
#>   expression      min   median `itr/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl>
#> 1 loop10      22.46µs  24.12µs    34506.
#> 2 loop100    704.93µs 808.17µs     1090.
#> 3 vec10        5.99µs   6.35µs   140159.
#> 4 vec100         40µs   41.6µs    22131.
```
