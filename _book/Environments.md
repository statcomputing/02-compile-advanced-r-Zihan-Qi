...
```r
env_parents(e2b)
#> [[1]]   <env: 0x7ff6d87d1af0>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0x7ff6dd812cf0>
#> [[2]] $ <env: empty>
```
