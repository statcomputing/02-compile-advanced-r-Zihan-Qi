...
|:-----------|:----------|:----------------------------|
|bench       |1.1.1      |CRAN (R 3.6.0)               |
|bookdown    |0.20       |CRAN (R 3.6.2)               |
|dbplyr      |1.4.4      |CRAN (R 3.6.2)               |
|desc        |1.2.0      |CRAN (R 3.6.0)               |
|emo         |0.0.0.9000 |Github (hadley/emo\@3f03b11) |
|ggbeeswarm  |0.6.0      |CRAN (R 3.6.0)               |
|ggplot2     |3.3.2      |CRAN (R 3.6.2)               |
|knitr       |1.28       |CRAN (R 3.6.0)               |
|lobstr      |1.1.1      |CRAN (R 3.6.0)               |
|memoise     |1.1.0      |CRAN (R 3.6.0)               |
|png         |NA         |NA                           |
|profvis     |0.3.6      |CRAN (R 3.6.0)               |
|Rcpp        |1.0.5      |CRAN (R 3.6.2)               |
|rlang       |0.4.7      |CRAN (R 3.6.2)               |
|rmarkdown   |2.3        |CRAN (R 3.6.2)               |
|RSQLite     |2.2.0      |CRAN (R 3.6.0)               |
|scales      |1.1.1      |CRAN (R 3.6.2)               |
|sessioninfo |1.1.1      |CRAN (R 3.6.0)               |
|sloop       |1.0.1      |CRAN (R 3.6.0)               |
|testthat    |2.3.2      |CRAN (R 3.6.0)               |
|tidyr       |1.0.2      |CRAN (R 3.6.0)               |
|vctrs       |0.2.4      |CRAN (R 3.6.0)               |
|zeallot     |0.1.0      |CRAN (R 3.6.0)               |
